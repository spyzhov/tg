...
def main():
    ...
    content = requests.get(URL, headers={'Agent':f'github.com/spyzhov/{PACKET}'}).text
...
If this has happened, please [inform the author](https://github.com/spyzhov/{PACKET}/issues/new).
...
''')
    ...
    with open('doc.go', 'w') as objects:
        objects.write(f'''// Package {PACKET} implements Telegram Bot API
//
// > Generated: **{datetime.date.today().strftime('%d %B %Y')}**
//
...
//
// API for Bot was generated automatically using original documentation and may has the difference.
// If this has happened, please inform the author with new issue https://github.com/spyzhov/{PACKET}/issues/new
//
package {PACKET}
''')
